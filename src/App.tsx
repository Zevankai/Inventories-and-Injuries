...
import { ITEM_CATEGORIES, DEFAULT_CATEGORY_WEIGHTS, PACK_DEFINITIONS, STORAGE_DEFINITIONS, EXPANDED_POPOVER_ID, WIDE_POPOVER_WIDTH, TOKEN_TYPE_LABELS, TOKEN_TYPE_ORDER } from './constants';
import type { Item, ItemCategory, StorageType, CharacterData, Vault, Currency, Tab, LoreTabId, LoreEntry, TokenType, RestType, MonsterSettings } from './types';
...
function App() {
  ...
  } = useTradeManager({ ready, playerId, playerRole, playerClaimedTokenId, checkProximity });
